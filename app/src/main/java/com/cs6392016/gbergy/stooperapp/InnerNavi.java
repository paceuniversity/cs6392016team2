...
public class InnerNavi extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.inner_navi, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.clisting) {
            ...
            manager.beginTransaction().replace(R.id.defaultinnerfrag, createlisting, createlisting.getTag()).commit();
        } else if (id == R.id.flisting) {
            Findlisting findlisting = new Findlisting();
            FragmentManager manager = getSupportFragmentManager();
