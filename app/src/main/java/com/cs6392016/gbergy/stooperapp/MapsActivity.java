...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Park Slope and move the camera
        LatLng parkSlope = new LatLng(40.6710403, -73.9988001);
        mMap.addMarker(new MarkerOptions().position(parkSlope).title("Park Slope, Brooklyn"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(parkSlope, 15));
